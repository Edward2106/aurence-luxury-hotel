...
(function () {
  ...
  const hotels = [
    { 
      ...
      reviews: 842, 
      image: hotel3, 
      gallery: [hotel3, hotel1, spa, hotel2], 
    ...
    { 
      ...
      reviews: 1204, 
      image: hotel1, 
      gallery: [hotel1, hotel2, spa, hotel4], 
    ...
    { 
      ...
      reviews: 967, 
      image: hotel2, 
      gallery: [hotel2, hotel1, spa, hotel3], 
    ...
    { 
      ...
      reviews: 512, 
      image: hotel4, 
      gallery: [hotel4, spa, hotel1, hotel2], 
    ...
    { 
      ...
      reviews: 388, 
      image: hotel1, 
      gallery: [hotel1, spa, hotel2, hotel4], 
  ...
  const destinations = [
    { name: "Đà Nẵng", count: 12, image: hotel3 },
    { name: "Nha Trang", count: 8, image: hotel1 },
    { name: "Phú Quốc", count: 15, image: hotel2 },
    { name: "Đà Lạt", count: 6, image: hotel4 },
    { name: "Hạ Long", count: 10, image: hotel3 },
    { name: "Hội An", count: 7, image: hotel1 }
  ];

  const rooms = [
    { id: "RM001", hotelId: "aurence-danang", roomNumber: "101", name: "Phòng Deluxe Hướng Biển", size: "48 m²", beds: "1 Giường King", price: 3500000, capacity: 2, image: hotel1, status: "Còn trống" },
    { id: "RM002", hotelId: "aurence-danang", roomNumber: "102", name: "Biệt Thự Hồ Bơi Riêng", size: "85 m²", beds: "1 Giường King", price: 6500000, capacity: 2, image: hotel3, status: "Đang sử dụng" },
    { id: "RM003", hotelId: "aurence-nhatrang", roomNumber: "201", name: "Phòng Suite Hướng Vịnh", size: "60 m²", beds: "1 Giường King", price: 2800000, capacity: 2, image: hotel2, status: "Còn trống" },
    { id: "RM004", hotelId: "aurence-nhatrang", roomNumber: "202", name: "Phòng Gia Đình Sang Trọng", size: "75 m²", beds: "2 Giường Đôi", price: 4500000, capacity: 4, image: hotel4, status: "Đang dọn dẹp" },
    { id: "RM005", hotelId: "aurence-halong", roomNumber: "301", name: "Phòng Premium Hướng Vịnh", size: "52 m²", beds: "1 Giường King", price: 4200000, capacity: 2, image: hotel1, status: "Còn trống" },
    { id: "RM006", hotelId: "aurence-halong", roomNumber: "302", name: "Dinh Thự Tổng Thống Hướng Biển", size: "150 m²", beds: "2 Giường King", price: 12000000, capacity: 4, image: hotel2, status: "Đang bảo trì" },
    { id: "RM007", hotelId: "aurence-dalat", roomNumber: "401", name: "Phòng Superior Hướng Hồ", size: "40 m²", beds: "1 Giường Queen", price: 2200000, capacity: 2, image: hotel4, status: "Còn trống" },
    { id: "RM008", hotelId: "aurence-dalat", roomNumber: "402", name: "Biệt Thự Rừng Thông Cổ Điển", size: "90 m²", beds: "1 Giường King + 1 Giường Đơn", price: 4800000, capacity: 3, image: hotel1, status: "Đã đặt" },
    { id: "RM009", hotelId: "aurence-phuquoc", roomNumber: "501", name: "Phòng Deluxe Sân Vườn", size: "45 m²", beds: "2 Giường Đơn", price: 3800000, capacity: 2, image: hotel2, status: "Còn trống" },
    { id: "RM010", hotelId: "aurence-phuquoc", roomNumber: "502", name: "Biệt Thự Bãi Biển Thượng Hạng", size: "120 m²", beds: "2 Giường King", price: 9500000, capacity: 4, image: hotel3, status: "Còn trống" },
    { id: "RM011", hotelId: "aurence-hoian", roomNumber: "601", name: "Phòng Classic Phố Cổ", size: "42 m²", beds: "1 Giường King", price: 2500000, capacity: 2, image: hotel4, status: "Còn trống" },
    { id: "RM012", hotelId: "aurence-hoian", roomNumber: "602", name: "Phòng Suite Di Sản", size: "65 m²", beds: "1 Giường King + 1 Sofa Bed", price: 4000000, capacity: 3, image: hotel1, status: "Còn trống" }
  ];
  ...
  const services = [
    { id: "SV001", name: "Ẩm thực tại phòng", desc: "Dịch vụ ăn uống phục vụ 24/7 tại phòng do đầu bếp Michelin thực hiện.", price: 750000, category: "Dịch vụ phòng", image: spa },
    { id: "SV002", name: "Trị liệu Spa cao cấp", desc: "Liệu pháp massage thư giãn, xông hơi và chăm sóc da mặt chuyên sâu.", price: 1800000, category: "Spa", image: spa },
    { id: "SV003", name: "Đưa đón sân bay hạng sang", desc: "Đưa đón sân bay bằng dòng xe sang Mercedes-Benz S-Class hoặc Maybach.", price: 1200000, category: "Đưa đón sân bay", image: spa },
    { id: "SV004", name: "Đặt bàn nhà hàng Fine Dining", desc: "Trải nghiệm ẩm thực thượng hạng tại nhà hàng Michelin của chúng tôi.", price: 2500000, category: "Nhà hàng", image: spa },
    { id: "SV005", name: "Dịch vụ giặt là cao cấp", desc: "Giặt, ủi và làm sạch giày cao cấp, giao nhận trong ngày.", price: 300000, category: "Giặt ủi", image: spa },
    { id: "SV006", name: "Huấn luyện viên gym cá nhân", desc: "Giờ tập riêng cùng huấn luyện viên thể hình chuyên nghiệp tại phòng gym.", price: 800000, category: "Phòng tập thể dục", image: spa },
    { id: "SV007", name: "Thiết lập Wi-Fi tốc độ cao riêng", desc: "Đường truyền Internet băng thông rộng chuyên dụng cho công việc hoặc sự kiện.", price: 500000, category: "Hỗ trợ Wi-Fi", image: spa },
    { id: "SV008", name: "Trang trí phòng sự kiện", desc: "Thiết lập hoa tươi, bóng bay hoặc nến cho dịp kỷ niệm ngày cưới, sinh nhật.", price: 1500000, category: "Dịch vụ phòng", image: spa }
  ];
