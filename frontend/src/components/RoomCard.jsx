...
export const RoomCard = ({ roomType, onSelect }) => {
  ...
  const price = normalizePrice(roomType.basePrice ?? roomType.pricePerNight ?? roomType.price);
    ...
    <div className="p-6 rounded-3xl bg-navy-900 border border-gold-500/20 flex flex-col md:flex-row gap-6 items-center">
      ...
      <div className="flex-1 space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className="text-base font-bold gold-gradient-text">{formatCurrencyVND(price)}</span>
        </div>
